    ...
    <div class="caro-back">
        ...
        <section id="carousel" class="carousel">
            ...
            <div class="item">
                ...
                <p class="carousel-caption">Evento de impresión 3D - Makers lab</p>
            </div>
            <div class="item">
                <img src="../../rutadelsaber/assets/img/Thinking/3.jpeg" alt="Imagen 3">
                <p class="carousel-caption">¿A dónde vamos a llegar? Conversatorio - DatIA</p>
            </div>
            <div class="item">
                <img src="../../rutadelsaber/assets/img/Thinking/4.jpeg" alt="Imagen 4">
                <p class="carousel-caption">Participación en torneo de ajedrez - Gambito</p>
            </div>
            </div>
        </div>
    </section>
